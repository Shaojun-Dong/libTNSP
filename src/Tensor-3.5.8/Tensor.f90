...
!**************************************************************************************************************
	...
	subroutine modifyTen_val1_Tensor(Ten,dimen,val)
		...
		select case(val%getType())
			case (1)
				call modify_TData_class(Ten,(/dimen/),(/getTotalData(Ten)/),1,val%ii(1))
				!call modifyTen_val_class(Ten,(/dimen/),val%ii(1))
			case (2)
				call modify_TData_class(Ten,(/dimen/),(/getTotalData(Ten)/),1,val%si(1))
				!call modifyTen_val_class(Ten,(/dimen/),val%si(1))	
			case (3)
				!call modifyTen_val_class(Ten,(/dimen/),val%di(1))
				call modify_TData_class(Ten,(/dimen/),(/getTotalData(Ten)/),1,val%di(1))
			case (4)
				!call modifyTen_val_class(Ten,(/dimen/),val%ci(1))
				call modify_TData_class(Ten,(/dimen/),(/getTotalData(Ten)/),1,val%ci(1))
			case (5)
				!call modifyTen_val_class(Ten,(/dimen/),val%zi(1))
				call modify_TData_class(Ten,(/dimen/),(/getTotalData(Ten)/),1,val%zi(1))
			case (6)
				!call modifyTen_val_class(Ten,(/dimen/),val%li(1))
				call modify_TData_class(Ten,(/dimen/),(/getTotalData(Ten)/),1,val%li(1))
			case (7)
				!call modifyTen_val_class(Ten,(/dimen/),val%ai(1))
				call modify_TData_class(Ten,(/dimen/),(/getTotalData(Ten)/),1,val%ai(1))
			case default
				call writemess("ERROR in modifyTen_val_Tensor",-1)
				call error_stop()
		end select
